...
package com.app.smile.india.ui.userTypeActivities.customer.mainActivity.fragments.reports.passwordManage.tabs
                ...
                when {
                    ...
                    !etNewPassword.text.toString().equals(etConfirmPassword.text.toString()) -> {
                        ...
                        ChangePasswordReq(
                            ...
                            obj = com.app.smile.india.models.passwordManage.changePassword.Obj(
