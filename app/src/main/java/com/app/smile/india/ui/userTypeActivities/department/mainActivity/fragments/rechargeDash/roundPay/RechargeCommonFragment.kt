...
package com.app.smile.india.ui.userTypeActivities.department.mainActivity.fragments.rechargeDash.roundPay
...
import com.app.smile.india.models.bbpsRecharge.circle.GetCircleRes
import com.app.smile.india.models.bbpsRecharge.mobileLookup.GetMobileLookupReq
import com.app.smile.india.models.bbpsRecharge.mobileLookup.GetMobileLookupRes
import com.app.smile.india.models.bbpsRecharge.operator.GetOperatorReq
import com.app.smile.india.models.bbpsRecharge.operator.GetOperatorRes
import com.app.smile.india.models.bbpsRecharge.operatorLocal.GetOperatorLocalReq
import com.app.smile.india.models.bbpsRecharge.operatorLocal.GetOperatorLocalRes
import com.app.smile.india.models.fetchBill.FetchBillRes
...
import com.app.smile.india.ui.userTypeActivities.department.mainActivity.fragments.rechargeDash.roundPay.dthPlanList.DthListActivity
...
//        }
        ...
        getOperator(
            GetOperatorReq(
                apiname = "GetRechargeOperator",
                obj = com.app.smile.india.models.bbpsRecharge.operator.Obj(Type = "$rechargeType")
            )
        )
                                        ...
                                        when {
                                            operatorId.equals(opListId[i]) -> {
                                                ...
                                                getOperatorLocal(
                                                    GetOperatorLocalReq(
                                                        apiname = "GetRechargeOperator",
                                                        obj = com.app.smile.india.models.bbpsRecharge.operatorLocal.Obj(
                                                            Type = "" + rechargeType,
