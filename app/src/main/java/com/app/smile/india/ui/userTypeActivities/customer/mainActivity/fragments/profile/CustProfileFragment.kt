...
package com.app.smile.india.ui.userTypeActivities.customer.mainActivity.fragments.profile
...
import com.app.smile.india.databinding.FragmentCustProfileBinding
...
class CustProfileFragment : Fragment(), KodeinAware, DashboardItemsAdapter.OnItemClickListener {
    private lateinit var binding: FragmentCustProfileBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentCustProfileBinding.inflate(layoutInflater)
        return binding.root
    }
...
//                (activity as CustMainActivity).openWebIntent("https://smileindiaeshop.com/home/userregistration?userid=" + preferenceManager.userid + "&sp=1")
//            }
//            cardRightRef.setOnClickListener {
//                (activity as CustMainActivity).openWebIntent("https://smileindiaeshop.com/home/userregistration?userid=" + preferenceManager.userid + "&sp=2")
//            }
        }
    }
