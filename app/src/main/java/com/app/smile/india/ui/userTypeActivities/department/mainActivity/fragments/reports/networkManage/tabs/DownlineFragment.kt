...
import com.app.smile.india.adapters.networkManage.DownlineAdapter
...
import com.app.smile.india.models.networkManage.downline.GetDownlineRes
...
class DownlineFragment : Fragment(), KodeinAware, DownlineAdapter.OnItemClickListener {
    ...
    private fun hitApis() {
        getReport(
            GetDownlineReq(
                apiname = "GetTeam",
                obj = com.app.smile.india.models.networkManage.downline.Obj(
                    direction = "1",
                    from = "",
                    status = "-1",
                    to = "",
