...
package com.app.smile.india.ui.userTypeActivities.customer
...
import com.app.smile.india.databinding.ActivityCustMainBinding
...
import com.app.smile.india.utils.ConnectionLiveData
...
class CustMainActivity : AppCompatActivity(), KodeinAware {
    override val kodein by kodein()
    private val factory: SharedVMF by instance()
    private lateinit var viewModel: SharedVM

    private lateinit var preferenceManager: PreferenceManager
    private lateinit var binding: ActivityCustMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCustMainBinding.inflate(layoutInflater)
...
//        }
        ...
        popUpMenu.inflate(R.menu.cust_menu)
...
//                    openWebIntent("https://smileindiaeshop.com/Home/UserRegistration?userid=" + preferenceManager.userid)
//                    true
//                }
...
//                }
                ...
                R.id.nav_about -> {
                    binding.drawerlayout.closeDrawer(GravityCompat.START)
                    openWebIntent("https://smileindiaeshop.com/")
                    true
                }
    ...
    fun openWebIntent(url: String) {
        try {
            ...
            Log.e("Exception ", "" + e)
            Toast.makeText(this@CustMainActivity, "" + e, Toast.LENGTH_LONG).show()
        }
    }
