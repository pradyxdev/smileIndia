...
import com.app.smile.india.models.dummys.items.ItemsMD

object Constants {
    // add api base url
    const val BaseUrl = "https://api.smileindiaeshop.com/api/"
    ...
    var imgBaseUrl = "https://smileindiaeshop.com/Resources/"
...
//    )
    ...
    val itemRecharge2 = listOf(
        ...
        CategoryMD(img = R.drawable.gas_bottle, name = "Lpg Booking"),
    ...
    val gstPaysprintStateNameArray = arrayListOf(
        "Andhra Pradesh Telangana",
        "Assam",
        "Bihar Jharkhand",
        "Chennai",
    ...
    val gstPaysprintStateCodeArray = arrayListOf(
        "01",
        "02",
        "03",
        "04",
