...
import com.app.ulife.creatoron.helpers.PreferenceManager.Companion.instance
...
interface MyApi {
    ...
    @POST("PaysPrint/LPGOperatorList")
    suspend fun getLpgBbpsOperator(
        @Body parameter: RequestBody
    ): Response<String>
    ...
    @POST("PaysPrint/LPGFetch")
    suspend fun getPsFetchLpgOperator(
        @Body parameter: RequestBody
    ): Response<String>

    @POST("PaysPrint/BookLPG")
    suspend fun doPsLpgBillPay(
        @Body parameter: RequestBody
    ): Response<String>
