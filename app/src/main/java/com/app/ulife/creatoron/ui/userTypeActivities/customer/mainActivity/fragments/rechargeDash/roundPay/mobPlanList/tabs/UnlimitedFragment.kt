...
class UnlimitedFragment : Fragment(), KodeinAware, PlanListAdapter.OnItemClickListener {
...
//            binding.root.snackbar("error: no plans found !!", "i")
            ...
            binding.apply {
                ...
                for (i in (activity as PlanListActivity).plansList.indices) {
                    if ((activity as PlanListActivity).plansList[i].types_Id == Constants.planTypeUnlimited) {
                        filteredList.add(
                            PDetail(
