...
import com.app.ulife.creatoron.adapters.epinManage.EpinTransferReportAdapter
...
class TransferEpinReportFragment : Fragment(), KodeinAware,
    EpinTransferReportAdapter.OnItemClickListener {
    ...
    private fun setupViews() {
        binding.apply {
            ...
            binding.tvToolbarTitle.text = "Transfer E-Pin Report"
            hitApis()
        }
    }
                ...
                if (response != null) {
                    if (response.status) {
                        ...
                        binding.apply {
                            ...
                            rvList.apply {
                                adapter = EpinTransferReportAdapter(
                                    context,
                                    response.data,
                                    this@TransferEpinReportFragment
                                )
