...
package com.app.ulife.creatoron.adapters.networkManage
...
import com.app.ulife.creatoron.databinding.ItemsDirectTeamBinding
import com.app.ulife.creatoron.models.networkManage.directTeam.Data
import kotlin.random.Random


class DirectTeamAdapter(
    var context: Context,
    private val list: List<Data>,
    internal var listener: OnItemClickListener
) :
    RecyclerView.Adapter<DirectTeamAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ItemsDirectTeamBinding.inflate(
    ...
    inner class ViewHolder(private val binding: ItemsDirectTeamBinding) :
...
//                ivImg.setColorFilter(color, android.graphics.PorterDuff.Mode.SRC_IN)
                ...
                tvEmail.text = "${response?.Email.toString().ifEmpty { "N/A" }}"
