...
package com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.rechargeDash.roundPay
...
import com.app.ulife.creatoron.databinding.FragmentRechargeCommonBinding
...
import com.app.ulife.creatoron.models.bbpsRecharge.circle.GetCircleRes
import com.app.ulife.creatoron.models.bbpsRecharge.mobileLookup.GetMobileLookupReq
import com.app.ulife.creatoron.models.bbpsRecharge.mobileLookup.GetMobileLookupRes
import com.app.ulife.creatoron.models.bbpsRecharge.operator.GetOperatorReq
import com.app.ulife.creatoron.models.bbpsRecharge.operator.GetOperatorRes
import com.app.ulife.creatoron.models.bbpsRecharge.operatorLocal.GetOperatorLocalReq
import com.app.ulife.creatoron.models.bbpsRecharge.operatorLocal.GetOperatorLocalRes
import com.app.ulife.creatoron.models.fetchBill.FetchBillRes
...
import com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.rechargeDash.roundPay.dthPlanList.DthListActivity
import com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.rechargeDash.roundPay.mobPlanList.PlanListActivity
...
//        }
        ...
        getOperator(
            GetOperatorReq(
                apiname = "GetRechargeOperator",
                obj = com.app.ulife.creatoron.models.bbpsRecharge.operator.Obj(Type = "$rechargeType")
            )
        )
                                        ...
                                        when {
                                            operatorId.equals(opListId[i]) -> {
                                                ...
                                                getOperatorLocal(
                                                    GetOperatorLocalReq(
                                                        apiname = "GetRechargeOperator",
                                                        obj = com.app.ulife.creatoron.models.bbpsRecharge.operatorLocal.Obj(
                                                            Type = "" + rechargeType,
