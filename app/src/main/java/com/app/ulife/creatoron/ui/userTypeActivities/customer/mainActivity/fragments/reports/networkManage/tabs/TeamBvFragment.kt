...
import com.app.ulife.creatoron.adapters.networkManage.TeamBvAdapter
...
import com.app.ulife.creatoron.models.networkManage.teamBv.GetTeamBvRes
...
class TeamBvFragment : Fragment(), KodeinAware, TeamBvAdapter.OnItemClickListener {
    ...
    private fun hitApis() {
        getReport(
            GetTeamBvReq(
                apiname = "GetBVDetail",
                obj = com.app.ulife.creatoron.models.networkManage.teamBv.Obj(
                    fromdate = "",
                    fromuserid = "-1",
                    status = "",
                    todate = "",
