...
import com.app.ulife.creatoron.adapters.payout.MatchingIncomeAdapter
...
import com.app.ulife.creatoron.models.payoutManage.matchingIncome.GetMatchingIncomeRes
    ...
    private fun hitApis() {
        getReport(
            GetDirectIncomeReq(
                ...
                obj = com.app.ulife.creatoron.models.payoutManage.directIncome.Obj(
                    from = "",
                    to = "",
