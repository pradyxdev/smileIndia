...
package com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.reports.orders
...
import com.app.ulife.creatoron.adapters.ecom.OrderDetailsItemAdapter
import com.app.ulife.creatoron.databinding.FragmentOrderDetailslBinding
...
import com.app.ulife.creatoron.models.orderHistory.Data
import com.app.ulife.creatoron.models.orderItems.Obj
import com.app.ulife.creatoron.models.orderItems.OrderItemsReq
import com.app.ulife.creatoron.models.orderItems.OrderItemsRes
    ...
    private fun getOrderItems(request: OrderItemsReq) {
        ...
        viewModel.getOrderItems.observe(requireActivity()) {
            try {
                ...
                if (response.status) {
                    val list = mutableListOf<com.app.ulife.creatoron.models.orderItems.Data>()
