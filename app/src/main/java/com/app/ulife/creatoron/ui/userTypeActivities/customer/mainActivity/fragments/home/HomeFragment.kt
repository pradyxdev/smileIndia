...
import com.app.ulife.creatoron.adapters.ecom.CategoryAdapter
import com.app.ulife.creatoron.adapters.ecom.ItemsGridAdapter
import com.app.ulife.creatoron.adapters.ecom.SliderAdapter
import com.app.ulife.creatoron.databinding.FragmentHomeBinding
...
import com.app.ulife.creatoron.models.SliderItemsModel
...
import com.app.ulife.creatoron.models.banner.GetBannerRes
import com.app.ulife.creatoron.models.cart.GetCartRes
import com.app.ulife.creatoron.models.getCat.Data
import com.app.ulife.creatoron.models.getCat.GetCategoryReq
import com.app.ulife.creatoron.models.getCat.GetCategoryRes
import com.app.ulife.creatoron.models.getCat.Obj
...
import com.app.ulife.creatoron.ui.SplashActivity
...
//        setupRandomSearchTxt()
    ...
    private fun hitApis() {
        ...
        setupSlider(EmptyRequest(apiname = "getBanner", obj = com.app.ulife.creatoron.models.Obj()))
        getArrival(
            GetProductListReq(
        ...
        when (s) {
            ...
            "add" -> {
                addToCart(
                    AddToCartReq(
                        apiname = "AddToCart",
                        obj = com.app.ulife.creatoron.models.addToCart.Obj(
