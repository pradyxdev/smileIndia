...
package com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.reports.withdrawalManage
...
import com.app.ulife.creatoron.databinding.FragmentWithdrawalContainerBinding
...
class WithdrawalContainerFragment : Fragment(), KodeinAware {
    private lateinit var binding: FragmentWithdrawalContainerBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentWithdrawalContainerBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    private fun listeners() {
        binding.apply {
            ...
            card2.setOnClickListener {
                val args = Bundle()
                args.putString("", "")
                findNavController().navigate(R.id.withdrawalReportFragment, args, getNavOptions())
            }
        }
    }
}