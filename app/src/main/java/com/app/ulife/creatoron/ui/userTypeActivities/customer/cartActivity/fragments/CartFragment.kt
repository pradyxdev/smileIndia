...
import com.app.ulife.creatoron.adapters.ecom.CartListAdapter
import com.app.ulife.creatoron.databinding.FragmentCartBinding
...
class CartFragment : Fragment(), KodeinAware, CartListAdapter.OnItemClickListener,
    ...
    override fun onDelete(productId: String) {
        deleteCart(
            DeleteCartReq(
                apiname = "Remove_Cart",
                obj = com.app.ulife.creatoron.models.deleteCart.Obj(
                    id = "" + productId,
