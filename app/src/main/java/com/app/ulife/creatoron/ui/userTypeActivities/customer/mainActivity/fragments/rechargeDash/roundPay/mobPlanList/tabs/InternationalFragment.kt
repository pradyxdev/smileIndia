...
package com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.rechargeDash.roundPay.mobPlanList.tabs
...
import com.app.ulife.creatoron.adapters.PlanListAdapter
...
class InternationalFragment : Fragment(), KodeinAware, PlanListAdapter.OnItemClickListener {
...
//            binding.root.snackbar("error: no plans found !!", "i")
            ...
            binding.apply {
                ...
                for (i in (activity as PlanListActivity).plansList.indices) {
                    if ((activity as PlanListActivity).plansList[i].types_Id == Constants.planTypeInternational) {
                        filteredList.add(
                            PDetail(
