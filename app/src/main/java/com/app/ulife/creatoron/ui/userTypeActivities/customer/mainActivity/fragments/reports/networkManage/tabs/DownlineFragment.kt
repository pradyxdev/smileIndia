...
import com.app.ulife.creatoron.adapters.networkManage.DownlineAdapter
...
import com.app.ulife.creatoron.models.networkManage.downline.GetDownlineRes
...
class DownlineFragment : Fragment(), KodeinAware, DownlineAdapter.OnItemClickListener {
    ...
    private fun hitApis() {
        getReport(
            GetDownlineReq(
                apiname = "GetTeam",
                obj = com.app.ulife.creatoron.models.networkManage.downline.Obj(
                    direction = "1",
                    from = "",
                    status = "-1",
                    to = "",
