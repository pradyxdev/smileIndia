...
package com.app.ulife.creatoron.ui.userTypeActivities.customer.mainActivity.fragments.rechargeDash.roundPay.dthPlanList.tabs
...
import com.app.ulife.creatoron.adapters.DthPlanListAdapter
...
import com.app.ulife.creatoron.models.bbpsRecharge.dthPlan.PDetial
...
class LanguagesFragment : Fragment(), KodeinAware, DthPlanListAdapter.OnItemClickListener {
...
//            binding.root.snackbar("error: no plans found !!", "i")
            ...
            binding.apply {
                ...
                for (i in (activity as DthListActivity).plansList.indices) {
                    if ((activity as DthListActivity).plansList[i].data_Id == Constants.planTypeDthLanguages) {
                        filteredList.add(
                            PDetial(
