...
import com.app.ulife.creator.adapters.networkManage.TeamBvAdapter
...
import com.app.ulife.creator.models.networkManage.teamBv.GetTeamBvRes
...
class TeamBvFragment : Fragment(), KodeinAware, TeamBvAdapter.OnItemClickListener {
    ...
    private fun hitApis() {
        getReport(
            GetTeamBvReq(
                apiname = "GetBVDetail",
                obj = com.app.ulife.creator.models.networkManage.teamBv.Obj(
                    fromdate = "",
                    fromuserid = "-1",
                    status = "",
                    todate = "",
