...
package com.app.ulife.creator.ui.userTypeActivities.customer.mainActivity.fragments.reports.passwordManage.tabs
...
import com.app.ulife.creator.databinding.FragmentChangePasswordBinding
...
class ChangeTransPasswordFragment : Fragment(), KodeinAware {
                ...
                when {
                    ...
                    !etNewPassword.text.toString().equals(etConfirmPassword.text.toString()) -> {
                        ...
                        ChangePasswordReq(
                            ...
                            obj = com.app.ulife.creator.models.passwordManage.changePassword.Obj(
