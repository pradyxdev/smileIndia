...
import com.app.ulife.creator.adapters.payout.RechargeIncomeAdapter
...
import com.app.ulife.creator.models.payoutManage.rechargeIncome.GetRechargeIncomeRes
    ...
    private fun hitApis() {
        getReport(
            GetRechargeIncomeReq(
                ...
                obj = com.app.ulife.creator.models.payoutManage.rechargeIncome.Obj(
                    from = "",
                    lvl = "",
                    to = "",
                    type = "",
