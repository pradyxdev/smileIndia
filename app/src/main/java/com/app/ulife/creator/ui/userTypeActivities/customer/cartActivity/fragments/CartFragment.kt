...
import com.app.ulife.creator.adapters.ecom.CartListAdapter
import com.app.ulife.creator.databinding.FragmentCartBinding
...
import com.app.ulife.creator.models.addToCart.Obj
...
import com.app.ulife.creator.models.deleteCart.DeleteCartRes
...
class CartFragment : Fragment(), KodeinAware, CartListAdapter.OnItemClickListener,
    ...
    override fun onDelete(productId: String) {
        deleteCart(
            DeleteCartReq(
                apiname = "Remove_Cart",
                obj = com.app.ulife.creator.models.deleteCart.Obj(
                    id = "" + productId,
