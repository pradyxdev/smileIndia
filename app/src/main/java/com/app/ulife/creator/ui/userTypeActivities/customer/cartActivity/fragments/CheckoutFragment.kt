...
package com.app.ulife.creator.ui.userTypeActivities.customer.cartActivity.fragments
...
import com.app.ulife.creator.adapters.ecom.AddressList2Adapter
import com.app.ulife.creator.databinding.FragmentCheckoutBinding
...
import com.app.ulife.creator.models.checkout.CheckoutOrderRes
import com.app.ulife.creator.models.getCity.GetCityReq
import com.app.ulife.creator.models.getCity.GetCityRes
import com.app.ulife.creator.models.getState.GetStateRes
import com.app.ulife.creator.models.shippingDetails.add.AddShippiDetailsReq
import com.app.ulife.creator.models.shippingDetails.add.AddShippiDetailsRes
import com.app.ulife.creator.models.shippingDetails.get.Data
import com.app.ulife.creator.models.shippingDetails.get.ShippDetailsRes
            ...
            btnConfirmOrder.onDebouncedListener {
                when {
                    ...
                    paymentMode.isNullOrEmpty() -> root.snackbar("Please select payment method")
                        ...
                        CheckoutOrderReq(
                            apiname = "PlaceOrder", obj = com.app.ulife.creator.models.checkout.Obj(
        ...
        actState?.onItemClickListener =
            AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                getCityList(
                    GetCityReq(
                        apiname = "BindCity",
                        obj = com.app.ulife.creator.models.getCity.Obj(StateId = "$stateId")
                    )
                )
            }
                ...
                etPincode?.text.toString().isEmpty() -> etPincode?.error = "Please enter pincode"
                    ...
                    addShippingDetails(
                        AddShippiDetailsReq(
                            ...
                            obj = com.app.ulife.creator.models.shippingDetails.add.Obj(
                                cityid = cityId,
                                companyname = "",
                                email = "",
